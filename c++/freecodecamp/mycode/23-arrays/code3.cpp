...
int main(){
    ...
    */
    ...
    std::cout << "size of the name is : " << std::size(inputname) << std::endl;
    if (std::size(inputname) > max_length) {
        end = true;
        std::cout << "You've entered a name longer than 15 characters so program ends here" << std::endl;
    }
